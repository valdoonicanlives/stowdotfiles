...
export EDITOR=$(find_alt nvim nano mousepad geany $OPENER )
export FILEMANAGER=$(find_alt pcmanfm thunar nautilus dolphin $OPENER )
...
export IMAGEVIEWER=$(find_alt sxviv risttreto feh display eog $OPENER )
